...
public function listContactCallback()
{
    if (isset($_GET['action']) && $_GET['action'] == "edit") {
        ...
        $students = $this->getContactData($student_id);
        $action = $this->action;
        $displayMessage = $this->message;
        include_once CMS_PLUGIN_PATH . "pages/add-student.php";
    } 
    elseif(isset($_GET['action']) && $_GET['action'] == "view"){
        ...
        $students = $wpdb->get_results("SELECT * FROM {$table_prefix}contact_system", ARRAY_A);
        include_once CMS_PLUGIN_PATH . "pages/list-student.php";   
    }
}
    ...
    private function getContactData($student_id)
    {
        global $wpdb;
        $table_prefix=$wpdb->prefix;
        $students= $wpdb->get_row(
            $wpdb->prepare("SELECT * FROM {$table_prefix}contact_system WHERE id=%d",$student_id), ARRAY_A
        );
        return $students;
    }
